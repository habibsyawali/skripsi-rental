...
if (isset($_POST["submit"])) {
	if ($_POST["submit"] == "Edit") {
		...
		$querytampilid = "select * from tb_mediumbus where id ='$id'";
	...
	if ((!$pesan_error) and ($_POST["submit"] == "Update Data")) {
		...
		$queryupdate = "update tb_mediumbus set ";
	...
	<div>
		...
		<div class="jumbotron">
			...
			<div class="container" style="height: 75vh; margin-top: 60px;">
				<h2 style="margin-bottom: 25px;">Edit Data Medium Bus</h2>
				<?php
				if ($pesan_error !== "") {
				...
				?>
				<form action="edit_mediumbus.php" method="post" name="update_data">
					<div>
