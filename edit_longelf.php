...
if (isset($_POST["submit"])) {
	if ($_POST["submit"] == "Edit") {
		...
		$querytampilid = "select * from tb_longelf where id ='$id'";
	...
	if ((!$pesan_error) and ($_POST["submit"] == "Update Data")) {
		...
		$queryupdate = "update tb_longelf set ";
		...
		if ($resultquery) {
			...
			header("Location: data_longelf.php?pesan_sukses={$pesan_sukses}");
		} else {
	...
	<div>
		...
		<div class="jumbotron">
			...
			<div class="container" style="height: 75vh; margin-top: 60px;">
				<h2 style="margin-bottom: 25px;">Edit Data Long Elf</h2>
				<?php
				if ($pesan_error !== "") {
				...
				?>
				<form action="edit_longelf.php" method="post" name="update_data">
					<div>
					...
					<div style="display: flex;">
						...
						<div style="margin: 20px 0px 0px 20px;">
							<a class="btn btn-danger" href="data_longelf.php">Batal</a>
						</div>
					</div>
				</form>
			</div>
