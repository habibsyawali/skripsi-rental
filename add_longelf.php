...
if (isset($_POST["submit"])) {
	...
	if (!$pesan_error) {
		...
		$querytambah = "INSERT INTO tb_longelf(bln_thn,d_aktual) ";
...
<head>
	<meta charset="UTF-8">
	<title>Tambah Data Long Elf</title>
	...
	<div>
		...
		<div class="jumbotron">
			...
			<div class="container" style="height: 75vh; margin-top: 60px;">
				<h2 style="margin-bottom: 25px;">Tambah Data Long Elf</h2>
				<?php
				if ($pesan_error !== "") {
				...
				?>
				<form action="add_longelf.php" method="post" name="form2">
					<div class="row">
