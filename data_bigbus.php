	...
	<div>
		...
		<div class="jumbotron">
			...
			<div class="container" style="height:fit-content; margin-top: 60px;">
				<h2 style="margin-bottom: 25px;">Data Big Buss</h2>
				<div class="d-flex justify-content-between my-4">
					...
					<a class="btn btn-primary" href="add_bigbus.php">Tambah Data</a>
				</div>
				<table class="table table-hover table-bordered">
					...
					?>
						<tr>
							...
							?>
							<td>
								<form action="edit_bigbus.php" method="post">
							...
							<td>
								<form action="hapus_bigbus.php" method="post">
									<input type="hidden" name="id" value="<?php echo "$data[id]"; ?>">
