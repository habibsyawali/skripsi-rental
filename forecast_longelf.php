...
$querysum = "select sum(d_aktual) from tb_longelf";
$pesan_error = "";
	...
	if ($_POST["submit"] = "Ganti Alpha") {
		...
		if (($pesan_error === "") and ($_POST["submit"] = "Ganti Alpha")) {
			...
			if ($resultquery) {
				...
				header("Location: forecast_longelf.php?pesan_sukses={$pesan_sukses}");
			} else {
	...
	<div>
		...
		<div class="jumbotron">
			...
			<div class="container" style="height: fit-content; margin-top: 60px;">
				<h2 style="margin-bottom: 25px;">Data Peramalan Pelanggan Armada Long Elf Periode Berikutnya</h2>
				<div style="margin-bottom: 10px;">
					...
					<div>
						...
						<div class="d-flex justify-content-between">
							<div>
								<form action="forecast_longelf.php" method="post" name="ubah_alpha">
				...
				<div class="row">
					<div class="col-sm-12">
						<table class="table table-hover table-bordered">
							...
							<h2 style="margin-bottom: 25px; margin-top: 50px;">Grafik Peramalan Pelanggan Armada Long Elf Periode Berikutnya</h2>
							<!-- Grafik -->
							<div class="t">
							...
							<script>
								...
								var dataFirst = {
									label: "Aktual",
									data: [<?php
											$querydaktual = "select d_aktual from tb_longelf";
								...
								var speedData = {
									labels: [<?php
												$querybulan = "select bln_thn from tb_longelf";
